...
Primera versión pública. Fusión de dos proyectos previos —el motor de
validación de **HolonMed Core** y la plataforma clínica de **Universal
InfonMed**— reconstruidos sobre una base sin dependencias con licencia
restrictiva.
...
Sin servidor de base de datos, sin descargas de terminología y sin
trámites de licencia. Incluye un vocabulario semilla de 111 conceptos
clínicos en español con sus sinónimos, que es contenido propio del
proyecto.
...
que la evidencia no validada no mueva la probabilidad, que las colisiones
se bloqueen, que un likelihood ratio mal configurado no produzca certezas
del 100 %, y que un hallazgo descartado no muestre un término que el
clínico nunca escribió.
